...
MODELS = [
    {
        'name': 'SAGE26 (Millennium)',
        'dir': './output/testmodels/Millennium_FFB/',
        'box_size': 500,
        'volume_fraction': 0.3,
        'hubble_h': 0.73,
        'color': 'black',
    ...
    {
        'name': 'SAGE C16',
        'dir': './output/testmodels/Millennium_vanilla/',
        'box_size': 500,
        'volume_fraction': 0.3,
        'hubble_h': 0.73,
        'color': 'blue',
    ...
    # {
    #     'name': 'SAGE26 no FFB',
    #     'dir': './output/testmodels/Millennium_noFFB/',
    #     'box_size': 500,
    #     'volume_fraction': 0.3,
    #     'hubble_h': 0.73,
    #     'color': 'purple',
    ...
    # {
    #     'name': 'evilSAGE',
    #     'dir': '../../SAGE_BROKEN/sage-model/output/millennium/',
    #     'box_size': 500,
    #     'volume_fraction': 0.5,
    #     'hubble_h': 0.73,
    #     'color': 'red',
    ...
    for model in MODELS:
        ...
        try:
            ...
            for bin_center in common_bins:
                ...
                # Ratio in linear space = 10^(log_stellar_quenched - log_stellar_sf)
