...
SMF_SimConfigs = [
    # SAGE26 simulations (solid lines)
    {
        'path': './output/testmodels/Millennium_FFB/', 
        'label': 'SAGE (latest)', 
        'color': 'black', 
    ...
    {
        'path': './output/testmodels/Millennium_kd12/', 
        'label': 'SAGE26 (KD12)', 
        'color': 'green', 
        'linestyle': '-',  # solid line
        'BoxSize': 500,  # h-1 Mpc
    ...
    {
        'path': './output/testmodels/Millennium_kmt09/', 
        'label': 'SAGE26 (KMT09)', 
        'color': 'red', 
        'linestyle': '-',  # solid line
        'BoxSize': 500,  # h-1 Mpc
    ...
    {
        'path': './output/testmodels/Millennium_gd14/', 
        'label': 'SAGE26 (GD14)', 
        'color': 'orange', 
        'linestyle': '-',  # solid line
        'BoxSize': 500,  # h-1 Mpc
    ...
    {
        'path': './output/testmodels/Millennium_k13/', 
        'label': 'SAGE26 (K13)', 
        'color': 'purple', 
        'linestyle': '-',  # solid line
        'BoxSize': 500,  # h-1 Mpc
