...
void test_multi_satellite_mass_conservation() {
    ...
    for(int i = 1; i <= 4; i++) {
        strip_from_satellite(0, i, 0.0, 1, galaxies, &run_params);
    }
...
void test_differential_stripping_by_mass() {
    ...
    strip_from_satellite(0, 2, 0.0, 1, galaxies, &run_params);
...
void test_no_self_stripping() {
    ...
    strip_from_satellite(0, 0, 0.0, 1, galaxies, &run_params);
