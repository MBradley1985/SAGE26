...
extern "C" {
    ...
    // extern void strip_from_satellite(const int centralgal, const int gal, const double Zcurr, const double dt, const double t_strip, struct GALAXY *galaxies, const struct params *run_params);
    ...
    extern void strip_from_satellite(const int centralgal, const int gal, const double Zcurr, const int nsteps, struct GALAXY *galaxies, const struct params *run_params);
