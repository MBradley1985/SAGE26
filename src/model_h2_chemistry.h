...
extern "C" {
    ...
    extern float calculate_molecular_fraction_BR06(float gas_surface_density_msun_pc2, float stellar_surface_density_msun_pc2, float disk_scale_length_pc);
    ...
    extern double calculate_tdep_K13_Gyr(float Sigma_gas_msun_pc2, float Sigma_star_msun_pc2, float rs_pc, float Z_prime, float f_H2);
    extern float calculate_H2_fraction_KD12(const float surface_density_msun_pc2, const float metallicity, const float clumping_factor);
