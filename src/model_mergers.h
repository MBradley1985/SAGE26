...
extern "C" {
    ...
    void grow_black_hole(const int merger_centralgal, const double mass_ratio, int from_instability, const double BHaccrete_in, struct GALAXY *galaxies, const struct params *run_params);
