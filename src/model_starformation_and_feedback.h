...
extern "C" {
    ...
    extern void starformation_and_feedback(const int p, const int centralgal, const double time, const double dt, const int halonr, const int halo_snapnum, const int step,
